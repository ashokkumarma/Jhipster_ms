...
class ProductsGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Products entity")
        ...
        .repeat(2) {
            ...
            .get("/services/products/api/products")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new products")
            .post("/services/products/api/products")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "productid":"0"
                ...
                , "trackinventory":"0"
                , "quantity":"0"
                , "requiresshipping":"SAMPLE_TEXT"
                , "dateadd":"2020-01-01T00:00:00.000Z"
                , "dateupd":"2020-01-01T00:00:00.000Z"
                , "chargetaxes":null
                , "dimension":"SAMPLE_TEXT"
                , "inventorypolicy":"SAMPLE_TEXT"
                , "idparent":"0"
                , "combinations":"SAMPLE_TEXT"
                }""")).asJson
            .check(status.is(201))
            ...
            .repeat(5) {
                ...
                .get("/services/products${new_products_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created products")
            .delete("/services/products${new_products_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
